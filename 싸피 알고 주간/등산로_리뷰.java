...
//
//            int highest = 0;
//            for (int i = 0; i < N; i++) {  // 지도 생성 및 최고 높이 찾기
...
//            int newy = y + dy[i];
//
//            if (!rangeCheck(newx, newy) && visited[newx][newy]) continue;
//
